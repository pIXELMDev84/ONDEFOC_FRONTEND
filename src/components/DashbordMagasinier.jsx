...
const handleLogout = () => {
  ...
  useEffect(() => {
    const fetchStockData = async () => {
      ...
      try {
        ...
        console.log(response.data.categories); // Vérification des données reçues
  ...
  // Calculs des totaux
  const totalGlobalProduits = stockData.reduce(
    (sum, category) => sum + (category.products?.reduce((s, p) => s + 1, 0) || 0),
    0
  );  
    ...
    <div className="dashboard">
      ...
      <div className="main-content">
        <div className="dashboard-container">
          {/* Section supérieure avec résumé et répartition côte à côte */}
